        ...
        <Router>
          ...
          <div style={{ marginLeft: navBarWidth + "px" }}>
            <Routes>
              ...
              <Route
                path="/ahliobs"
                element={<Navigate to="/ahliobs/changelog" replace />}
              />
              <Route
                path="/ahliobs/changelog"
                element={
                  <ChangelogPage
                    posts={ahliObsChangelog}
                    title="AhliObs - Changelog"
                  />
                }
              />
              {
                <Route
                  ...
                  element={
                    <HtmlPage
                      title="AhliObs - Shortcuts"
                      contentHtml={ahliObsShortcuts}
                    />
                  }
                />
              }
              <Route
                path="/gameheart"
                element={<Navigate to="/gameheart/v3/changelog" replace />}
              />
              <Route
                ...
                element={
                  <ChangelogPage
                    posts={gh3changelog}
                    title="GameHeart 3 - Changelog"
                  />
                }
              />
              <Route
                path="/pro2020ahlimod"
                element={<Navigate to="/pro2020ahlimod/changelog" replace />}
              />
              <Route
                path="/pro2020ahlimod/changelog"
                element={
                  <ChangelogPage
                    posts={pro2020AhliModChangelog}
                    title="Pro2020 AhliMod - Changelog"
                  />
                }
              />
              <Route
                path="/heroes"
                element={<Navigate to="/heroes/settings" replace />}
              />
              <Route
                path="/heroes/settings"
                element={
                  <HtmlPage
                    title="Heroes of the Storm - Settings"
                    contentHtml={heroesSettings}
                  />
                }
              />
              <Route
                ...
                element={
                  <HtmlPage
                    title="StarCraf 2 - Logos.SC2Mod"
                    contentHtml={sc2logosMod}
                  />
                }
              />
