...
public abstract class MpqEditorCompressionRule {
	 ...
	 * @param singleUnit
	 */
	public void setSingleUnit(final boolean singleUnit) {
	 ...
	 */
	public void setEncryptAdjusted(final boolean encryptAdjusted) {
	 ...
	 */
	public void setIncludeSectorChecksum(final boolean includeSectorChecksum) {
	 ...
	 */
	public void setCompressionMethod(final MpqEditorCompressionRuleMethod compressionMethod) {
